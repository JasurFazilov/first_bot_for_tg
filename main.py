...
#Подключение к боту
bot = telebot.TeleBot('6270180846:AAEBxxGsK4tsD-uXZJrehjb9HchveFoLgWU')
#Работа с локацией
...
def cart_handle(call):
    ...
    if call.data == 'clear_cart':
        ...
        bot.edit_message_text('Корзина очищена', user, message_id, reply_markup=buttons.main_menu_buttons(products))
        ...
        bot.edit_message_text('Корзина', user, message_id, reply_markup=)
